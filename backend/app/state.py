...
class AgentState(TypedDict, total=False):
    # --- input ---
    question: str
    dataset_source: dict[str, Any]   # {"type": "file", "path": ...} or {"type": "postgres", ...}
    dataset_name: str
    ...
    # --- planning ---
    plan: dict[str, Any]          # {"needs_sql": bool, "needs_stats": bool, "needs_forecast": bool, "intent": str}
    error: Optional[str]
    retries: int
    ...
    sql_result: Optional[dict[str, Any]]     # {"columns": [...], "rows": [...], "row_count": int}
    python_result: Optional[dict[str, Any]]  # stats output

    # --- visualization ---
    charts: list[dict[str, Any]]             # [{"title":..., "path":..., "type":..., "caption":...}]
